...
# Assuming 'tmp' is your final DataFrame after all calculations
# Convert the Polars DataFrame to a Pandas DataFrame for Plotly
df_plot = tmp.filter(pl.col("hs4") == "9880").select().to_pandas()
.filter(pl.col("hs4") == "9880")
# Select relevant columns for the table
table_data = df_plot[['date', 'hs4', 'moving_price_imports', 'moving_price_exports',
                      'pct_change_imports_year_over_year', 'pct_change_exports_year_over_year',
                      'rank_imports', 'rank_exports']]
